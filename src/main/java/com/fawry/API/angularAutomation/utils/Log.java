...
//GeneralConstants
    ...
    static boolean  addLogToExtentReportFlag = (generalCofigsProps.getProperty(GeneralConstants.ADD_LOG_TO_EXTENT_REPORT).equalsIgnoreCase(GeneralConstants.TRUE));



// Initialize Log4j logs

    private static final Logger Log = LogManager.getLogger(com.fawry.API.angularAutomation.utils.Log.class.getName());//
    ...
    public static void AssertionError (String message, AssertionError e) {
